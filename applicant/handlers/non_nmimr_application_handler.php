 ...
 * The main submission logic has been moved to SubmissionEngine::submitNonNmimr().
 *
 * Original submission logic has been deprecated.
 ...
 * It now delegates to SubmissionEngine::submitNonNmimr().
 *
...
function handleSubmission(): array
{
    ...
    $result = SubmissionEngine::submitNonNmimr($_POST, $_FILES);
