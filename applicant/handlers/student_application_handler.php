...
function handleSubmission()
{
    ...
    foreach ($singleFileFields as $field => $label) {
        if (isset($_FILES[$field])) {
            ...
            if (!$result['success']) {
                if (
                    in_array($field, ['consent_form', 'data_instruments', 'approval_letter']) ||
    ...
    try {
        ...
        if ($applicationId > 0) {
            ...
            // ============================================
            // UPDATE EXISTING DRAFT → MARK AS SUBMITTED
            // ============================================
    ...
    ";
            ...
            // ============================================
            // NO DRAFT EXISTS → CREATE NEW SUBMISSION
            // ============================================
        ...
        INSERT INTO student_applications (
            ...
            :student_declaration_name, :student_declaration_date, :student_declaration_signature,
            :supervisor_declaration_name, :supervisor_declaration_date, :supervisor_declaration_signature,
            :application_type, 'submitted', 6, NOW(), NOW()
        )
    ";
