...
try {
    ...
    $data = [
        ...
        'logon_name'         => trim($_POST['logon_name'] ?? ''),
        'suffix'              => trim($_POST['suffix'] ?? ''),
        'contact_type'        => trim($_POST['contact_type'] ?? ''),
        'company_dept_name'   => trim($_POST['company_dept_name'] ?? ''),
        'active'              => isset($_POST['active']) ? 1 : 0,
        'specialty_1'         => trim($_POST['specialty_1'] ?? ''),
        'specialty_2'         => trim($_POST['specialty_2'] ?? ''),
        'research_education'  => trim($_POST['research_education'] ?? ''),
